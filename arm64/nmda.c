...
#define mgblock mgblock_NMDA
 extern double mgblock( _threadargsprotocomma_ double , double , double , double );
 /* declare global and static user variables */
#define eta_mg eta_mg_NMDA
 double eta_mg = 0.28011;
#define gamma_mg gamma_mg_NMDA
 double gamma_mg = 0.0625;
#define mg2o mg2o_NMDA
 double mg2o = 1.2;
 ...
 "gamma_mg_NMDA", &gamma_mg_NMDA,
 "eta_mg_NMDA", &eta_mg_NMDA,
 "mg2o_NMDA", &mg2o_NMDA,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 NMDA /Users/melissafasol/Desktop/Dendrite Modelling/nmda.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "NMDA two exponential synapse";
...
double mgblock ( _threadargsprotocomma_ double _lv , double _lgamma , double _leta , double _lmgo ) {
   double _lmgblock;
 _lmgblock = 1.0 / ( 1.0 + _leta * _lmgo * exp ( - _lgamma * _lv ) ) ;
...
static double _hoc_mgblock(void* _vptr) {
 ...
 _r =  mgblock ( _p, _ppvar, _thread, _nt, *getarg(1) , *getarg(2) , *getarg(3) , *getarg(4) );
 return(_r);
}
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   g = B - A ;
   i = g * ( v - e ) * mgblock ( _threadargscomma_ v , gamma_mg , eta_mg , mg2o ) ;
   }
 _current += i;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/melissafasol/Desktop/Dendrite Modelling/nmda.mod";
static const char* nmodl_file_text = 
